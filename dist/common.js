 ...
 */
bee.link = {
	'server': 'http://staff.weifanyun.com',
	'weixin': 'http://staff.huijiuguoji.com',
	'image': ''
}
 ...
 * 获取授权码
 */
bee.getCode = function () {
	var queryString = {
		appid: 'wx500d1d09ee93a851',
		redirect_uri: encodeURIComponent(bee.link.weixin + '/jump.html'),
		response_type: 'code',
 ...
 * @param boolean isSign
 */
bee.post = function (url, data, fn, isSign) {
	var result = {};
	for (var i in data) {
		if (data.hasOwnProperty(i)) {
			if (data[i] !== '') {
