/**
 * Created by Chrise on 2017/2/13.
 */
/*
 商城用商品展示放大镜效果
 */
jQuery.ljsGlasses = {
    pcGlasses: function (_obj) {
        ...
        _box.append("<div style='position:relative;'><b style='display:block;'><img style='display:block;' src='' /></b><span style='position:absolute;left:0;top:0;display:none;z-index:5;'></span></div><p style='position:absolute;overflow:hidden;top:0;display:none; z-index:99999'><img style='max-width:none;max-height:none;position:relative;left:0;top:0;' src='' /></p>");
        ...
        if (_length <= _obj.sums) {
            ...
            _nextbtn.click(function () {
                _moveindex++;
                if (_maxNum + _index >= _length) {
                    $(".spec-scroll .next").css("background-image", "url(" + 'images/product_details/rightarrow0ver.png' + ")");
                } else {
                    $(".spec-scroll .prev").css("background-image", "url(" + 'images/product_details/leftarrowstart.png' + ")");
                }
            ...
            _lastbtn.click(function () {
                ...
                if (_maxNum + _index < _length) {
                    $(".spec-scroll .prev").css("background-image", "url(" + 'images/product_details/leftarrow0ver.png' + ")");
                } else {
                    $(".spec-scroll .next").css("background-image", "url(" + 'images/product_details/rightarrowstart.png' + ")");
                }
                if (_moveindex <= 0) {
                    _moveindex = 0;
                }
