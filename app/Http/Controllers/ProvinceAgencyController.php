...
class ProvinceAgencyController extends Controller
{
    /**
     * 显示列表页面
     *
    ...
    public function index()
    {
        ...
        $uuids = $province->map(function ($item) {
            return $item->uuid;
        });
        ...
        $agency = $sf->mapWithKeys(function ($item) {
        ...
        return view('agency.province', [ 'provinces' => $province, 'agencyAreas' => $agencyArea, 'agencies' => $agency, 'wechatUsers' => $wechatUsers ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $agency->agent_type = config('const.agencies_agent_type_province');
        $agency->status = config('const.agencies_status_normal');
