        ...
        if (_length <= _obj.sums) {
            ...
            _nextbtn.click(function () {
                ...
                if (_maxNum + _index >= _length) {
                    $(".spec-scroll .next").css("background-image", "url(" + '/images/rightarrow0ver.png' + ")");
                } else {
                    $(".spec-scroll .prev").css("background-image", "url(" + '/images/leftarrowstart.png' + ")");
                }
            ...
            _lastbtn.click(function () {
                ...
                if (_maxNum + _index < _length) {
                    $(".spec-scroll .prev").css("background-image", "url(" + '/images/leftarrow0ver.png' + ")");
                } else {
                    $(".spec-scroll .next").css("background-image", "url(" + '/images/rightarrowstart.png' + ")");
                }
                if (_moveindex <= 0) {
                    _moveindex = 0;
                }
