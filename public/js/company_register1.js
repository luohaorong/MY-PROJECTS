							...
							if(img_size <= 6) {
								if(window.FileReader) {
									...
									reader.onload = function(e) {
										var img_preview1 = document.getElementById('img_preview1');
										var tempDivPreview = document.getElementById(divPreviewId);
										if(img_preview1 == null) {
											var img = document.createElement("img");
											img.setAttribute("id", 'img_preview1');
											img.setAttribute("src", e.target.result);
											tempDivPreview.appendChild(img);
										} else {
											tempDivPreview.removeChild(img_preview1);
											var img = document.createElement("img");
											img.setAttribute("id", 'img_preview1');
											img.setAttribute("src", e.target.result);
											tempDivPreview.appendChild(img);
								...
								if(filesize<=6){
									...
									if(browserVersion.indexOf("MSIE 9") > -1) {
										...
										if(newPreview == null) {
											...
											newPreview.style.marginLeft=160+"px";
...
//兼容ie9，获取文件大小
	...
	$('.save_go').click(function () {
        if(onoff1 && onoff2 && onoff3 && onoff4 && onoff6 && onoff7) {
            $('#content').hide().siblings('#register_container_sec').show()
