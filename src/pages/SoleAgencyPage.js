...
class SoleAgency extends React.Component{
	...
	render(){
		...
		const _explain='为进一步保障上下游联盟会员权益，荟酒网甄选各联盟酒庄供应商优质产品推出区域独家服务，只需极低门槛即可取得区域独家经营权，更安享互联网+技术支撑的贴心服务和经营支持。'
		return(
			<View className='SoleAgencyWap'>
				<Header middleTop={true} MiddleTextTop='荟酒网产品独家协议' isText={isText}/>
