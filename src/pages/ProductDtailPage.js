...
import boutique from '../assets/images/productDtail/boutique.png';
...
class ProductDtailPage extends React.Component{
		...
		bee.post('/wechat/goods/info',{
			...
			if(data.error_code){
				...
				This.setState({
					...
					isExclusive:(getPost.goods.is_exclusive==='true'&&userType=='agency')?true:false,//是否独家
	...
	upData(priceUuid,stationUuid,allData){
		...
		let resultUuid2;
		let resultIfo;
		resultUuid1=stationUuid+'_'+priceUuid;
		resultUuid2=priceUuid+'_'+stationUuid;
	...
	render(){
		...
		let exclusive_uuid=bee.getQueryString('uuid');
		let goodsIfo=(
			JSON.stringify(productDescribeData)!=='{}'?(
										<div className='describeContent'>
											...
											<div className='countryTicket'>
												...
												<div className='ticketWrap' style={this.state.goodsIfo.honor=='no'?productListImg1:productListImg2}>
													<img className='ticketImg' style={productListImg3} src='../assets/images/productDtail/win.png'/>
													<span>
														获奖
													</span>
												</div>
		...
		return(
			<View>
				...
				<Container scrollable={true} style={{position:'relative'}}>
					<Slide slideImg={resultIformation}/>
					<div className="productDetailList" >
						<img src={boutique} style={this.state.goodsIfo.is_boutique=='no'?productListImg1:productListImg2}/>
						<img src={exclusive} style={this.state.goodsIfo.is_exclusive=='false'?productListImg1:productListImg2} />
						<img src={new_p} style={this.state.goodsIfo.is_new=='no'?productListImg1:productListImg2} />
						<img src={pre_sale} style={this.state.goodsIfo.is_presale=='no'?productListImg1:productListImg2} />
					</div>
					...
					<section className='ifoContainer'>
						...
						<ServiceInformation titleStyle={titleStyle} contentStyle={contentStyle} title='库存' content={this.state.goodsIfo.stock_label}/>
				...
				<ProductDetailBttom shoppingNum={this.state.shoppingNum} submitCar={this.submitCar} exclusive_uuid={exclusive_uuid} isExclusive={this.state.isExclusive}/>
			</View>
		)
	}
}
